...
module.exports.run = async (client,message,args) => {
   if (!message.member.roles.cache.some((role) => role.name === '[Bot Testers]')) return message.channel.send("Ah, I think you are not a bot [Verifier] sorry!");
...
exports.conf = {
  ...
  exports.help = {
    name: "queue",
    description: "shows the bots in the queue",
    usage: ""
  };