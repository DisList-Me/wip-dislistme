...
module.exports.run = async (client, message, args) => {
  ...
  var seconds = timeleft.seconds;
    ...
    client.channels.cache.get("958323947320004618").send(`**${botdata.username}** just got **+1 Vote** from **${message.author.username}** **\`(Total Votes ${botdata.votes + 1})\`**`)
    ...
    .setImage('https://i.ibb.co/8DLptFP/static.png')
  ...
  if (botdata.dcwebhook) {
    ...
    const msg = new webhook.MessageBuilder()
      ...
      .setAvatar("https://i.ibb.co/8DLptFP/static.png")
